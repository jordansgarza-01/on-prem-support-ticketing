...
with assistant_container:
    ...
    st.markdown(
        ...
        "<div style='font-family: Helvetica, Arial, sans-serif; font-size: 1rem; font-weight: 700; color: #111111; margin-bottom: 0.35rem;'>Hello, and welcome. I am your on-prem technical support agent powered by GPT-4o Mini, and Python-3</div>"
